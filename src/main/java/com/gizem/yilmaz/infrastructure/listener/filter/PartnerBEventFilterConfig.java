...
@Configuration
public class PartnerBEventFilterConfig implements PartnerEventFilterConfig {

	@Bean
	RoutingFunction partnerBFilter(FunctionCatalog functionCatalog, FunctionProperties functionProperties,
